...
pub mod abyssal_source_attributes;
...
impl<'a> Repo<'a> {
  ...
  pub fn abyssal_source_attributes(&self) -> abyssal_source_attributes::Repo<'_> {
    abyssal_source_attributes::Repo::new(self.connection)
  }
