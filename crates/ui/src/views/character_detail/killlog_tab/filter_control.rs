//! Kill log filter control: segmented All/Kills/Losses selector.
...
use crate::{
  ...
  views::character_detail::{KilllogFilter, Message},
};

/// Builder for the kill log filter segmented control.
...
impl<'a> Component<'a> {
  ...
  pub fn new(filter: &'a KilllogFilter) -> Self {
    Self {
      filter,
    }
  }
