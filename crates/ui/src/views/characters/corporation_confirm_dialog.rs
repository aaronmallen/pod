//! Confirm-removal dialog for a corporation.
...
/// Messages emitted by the corporation confirm dialog.
#[derive(Clone, Debug)]
pub enum Message {
  /// The user confirmed the removal.
  Confirmed,
  /// The user dismissed the dialog without removing.
  Dismissed,
}

/// Builder for the remove-corporation confirmation dialog.
...
impl Component {
  /// Creates a new confirmation dialog for the named corporation.
  pub fn new(corporation_name: impl Into<String>) -> Self {
    Self {
      corporation_name: corporation_name.into(),
      window_height: 600.0,
      window_width: 800.0,
    }
  }

  /// Sets the window dimensions used to position the dialog.
  ...
  /// Renders the dialog into an iced element.
